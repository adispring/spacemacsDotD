...
(custom-set-variables
 ...
 '(geiser-active-implementations (quote (chez)) t)
 ...
 '(hl-todo-keyword-faces
   (quote
    (("TODO" . "#dc752f")
     ...
     ("XXX+" . "#dc752f")
     ("\\?\\?\\?+" . "#dc752f"))))
 '(imenu-create-index-function (quote css-imenu-make-index) t)
